function reviewAds()
{
  ...
  var values=sheet.getRange(row, 1, lr-row+1,34).getValues();
...
function variationChecking()
{
  ...
  var result2="";   
     for (var c=12-1; c<=34-1 ; c++) //column L to ah
     {
           ...
           if(c==13-1 || c==14-1 || c==15-1 || c==20-1 || c==23-1){continue};
           ...
           for (var r=1; r<values.length; r++)  //move along the rows
           {
                     ...
                     for (var k=35-1; k<=50-1; k++)  //for all keys
                     {
                           ...
                           if(n1 != n2)
                           {
                               result+="<br>"+ sheet.getRange(sr+r, c+1).getA1Notation()+ "--> "+refKey+"="+n1+"   vs   "+tempKey+"="+n2 ;
           ...
           for (var k=35-1; k<=50-1; k++)  //for all keys
           {
                           ...
                           if(n1 ==0)
                           {
                               result2+="<br>"+refKey+" is not used in "+ sheet.getRange(sr, c+1).getA1Notation();
          ...
          result=result2+"<br>---------------------------------<br>---------------------------------<br>"+result   
                  if(result!='<br>')
                  {
...
function countOccurance(phrase, string)
{
    ...
    {
        if(array[i].toString().toLowerCase()==phrase.toString().toLowerCase())
        {count++}
        else if(array[i].toString().toLowerCase()==phrase.toString().toLowerCase()+",")
        {count++}
