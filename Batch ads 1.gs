function nfl_womensTee() 
{
      ...
      var amTitle="1 Piece NFL "+name+" Short Sleeve Women's Tee Round neck Large, Football Themed L Size T-Shirt Jersey Sports Patterned Apparel, Team Logo Fan Fashion Athletic Team Spirit, Navy"
      var b1="1 Piece NFL "+fullName+" Short Sleeve Women's Tee Round neck Large, Football Themed L Size T-Shirt Jersey Sports Patterned Apparel, Team Logo Fan Fashion Athletic Team Spirit, Navy"
      var dim='Dimension: 6.00 x 6.00 x 1.00 Inches';
      var includes='Includes: 1 NFL Womens Tee';
      var b4="This Women's Tee is an ideal gift for a fan."
      ...
      var img=showWmImages();   //imShowSideBar();
     ...
     /// sheet.getRange(row, 18).setValue('This throw can be used out at a game, on a picnic, in the bedroom, or cuddled under in the den while watching the game on TV.')
      ...
      sheet.getRange(row, 2).setValue("NZCU4NWT");
