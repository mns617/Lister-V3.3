...
function getOverstockData(rng, mode2) 
{
...
//    Logger.log(html);
            ...
            Logger.log(html.slice(m1,m1+2000))
            ...
            var amPrice="";
            var isSale=isOnSale(getURL, html);
            ...
            else if(n1>=0)//when there is vairiation
            {
                                            ...
                                            var vFrm='=myvariation(R'+getRow+'C[0],R'+getRow+'C35:R'+getRow+'C50,R[0]C35:R[0]C50)'
                                                      ...
                                                      for (var k=1; k<qtyArr.length ; k++) 
                                                      {
                                                            ...
                                                            variation= replaceAll(variation, 'u0027', "'");
                                                           ...
                                                           // var longQty=qtyArr[k-1];
                                                            ...
                                                            arrVals.push([title, initials, today, asin, sellerSku, itemNo, variation, getURL, upc, comment,status, prodName,type, catagory,amPrice, b2, b3, b4, terms, imageMain, color,size,material, imFrm2, imFrm3, imFrm4,lenFrm3,lenFrm2,lenFrm,qty, price, profit, mTerms,b1]);
                                                 ...
                                                 if(sMode=="on")  
                                                 {
                                                       sheet.insertRowsAfter(getRow,arrVals.length);
