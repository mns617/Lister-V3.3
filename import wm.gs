       ...
       /* 
        ...
        for(var i in products)
        {
                   ...
                   //--------------------------//
                      ...
                      var tempArr=[wmTitle, initial, date, asin, sku, itemNo, skugridVar, url, upc, comment, status, amTitle, type, category, amPrice, b2,b3,b4,terms,imageMain, color,size,material, imFrm, imFrm, imFrm,lenFrm3,lenFrm2,lenFrm,isStock, currentPrice, profit]
